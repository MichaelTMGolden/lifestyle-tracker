...
namespace PersonalDashboard.Api.Migrations
{
    ...
    [Migration("20260919125044_DashboardPlanningAndProgress")]
    partial class DashboardPlanningAndProgress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalDashboard.Api.Domain.AppSecret", b =>
                {
            ...
            modelBuilder.Entity("PersonalDashboard.Api.Domain.Challenge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PersonalDashboard.Api.Domain.ChallengeEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PersonalDashboard.Api.Domain.Habit", b =>
                {
                    ...
                    b.Property<bool>("ShowInQuickActions")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("PersonalDashboard.Api.Domain.HabitTimer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PersonalDashboard.Api.Domain.ScheduleOverride", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ScheduleBlockId", "WeekStart")
                        .IsUnique();
            ...
            modelBuilder.Entity("PersonalDashboard.Api.Domain.WeeklyReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PersonalDashboard.Api.Domain.ChallengeEntry", b =>
                {
                    b.HasOne("PersonalDashboard.Api.Domain.Challenge", "Challenge")
                        .WithMany("Entries")
            ...
            modelBuilder.Entity("PersonalDashboard.Api.Domain.ScheduleOverride", b =>
                {
                    b.HasOne("PersonalDashboard.Api.Domain.ScheduleBlock", "ScheduleBlock")
                        .WithMany()
